...
def get_hyperparameters(model_path):
    ...
    hypar["model_path"] = (
        model_path  ## load trained weights from this path
    )
...
# hypar = get_hyperparameters()

# # Build Model
# net = build_model(hypar, device)


def inference(net, hypar, image):
    image_path = image
...
if __name__ == "__main__":
    image = "/home/mokhan/Codes/marvel_private/marvel_modeling/sd3_lora/output_lora_new/image_2.png"

    hypar = get_hyperparameters()

    # Build Model
    net = build_model(hypar, device)
    masked_image = inference(net, hypar, image)

    masked_image[0].save("masked_image.png")
